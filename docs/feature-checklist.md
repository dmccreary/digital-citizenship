...
| Per-chapter references | :white_check_mark: | Medium | 17 chapter-level references.md files |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :white_check_mark: | High | 9 browser-based apps for hands-on learning |
| MicroSim index catalog | :white_check_mark: | Medium | Visual gallery with cards showing all available simulations |
| Per-chapter quizzes | :white_check_mark: | High | 17 quiz files with questions aligned to learning objectives |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Chapter content | :white_check_mark: | Very High | 17 chapters with full text, examples, and exercises |
