...
description: "A comprehensive guide for teachers, library-media specialists, and technology coaches using the Digital Citizenship intelligent textbook in the classroom. Covers every feature, classroom usage tips, licensing, customization, and analytics."
---
...
!!! mascot-tip "Maka's Tip: Embed MicroSims Anywhere!"
    <img src="../img/mascot/tip.png" class="mascot-admonition-img" alt="Maka shares a tip">
    ...
    ```html
    <iframe src="https://dmccreary.github.io/digital-citizenship/sims/YOUR-MICROSIM-NAME/main.html"
...
1. Go to the textbook's GitHub repository: [dmccreary/digital-citizenship](https://github.com/dmccreary/digital-citizenship)
...
1. Go to [dmccreary/digital-citizenship](https://github.com/dmccreary/digital-citizenship)
...
4. Open your browser to `http://127.0.0.1:8000/digital-citizenship/` to see your customized version
