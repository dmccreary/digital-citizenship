---
title: "Chapter 13: What Is Misinformation?"
description: "Learn what misinformation is, how it spreads, and the emotional and curiosity hooks designers use to make you click and share."
...
- [Chapter 5: Private vs. Personal Information](../05-private-vs-personal-info/index.md)
- [Chapter 6: Passwords, Clickbait, and Staying Safe Online](../06-passwords-and-online-safety/index.md)
- [Chapter 7: What Is a Digital Footprint?](../07-what-is-a-digital-footprint/index.md)
...
!!! mascot-warning "Watch Out for the Hooks!"
    <img src="../../img/mascot/warning.png" class="mascot-admonition-img" alt="Maka the River Otter warning">
    The hooks are designed to skip past your thinking brain and grab your feelings. The simple cure is the slowest one: pause, take one breath, and ask, "What is this trying to make me feel right now?" Naming the feeling kicks your thinking brain back on. Pause, think, act!
...
<details markdown="1">
<summary>Hook Spotter — interactive p5.js MicroSim</summary>
Type: microsim
**sim-id:** hook-spotter<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
- A pretend headline card in the center, drawn to look like a thumbnail with bold text and a fake image.
...
- `createButton('Next headline')` to load the next pretend headline from a bank of fifteen.
- `createButton('Reset')` to clear the score.
- `createSelect()` to filter the bank by category: Hoax, Real news, Satire, Misinformation, Parody.
...
- File location: `docs/sims/hook-spotter/` with `main.html`, `main.js`, and `index.md`.
...
1. **Curiosity gap** — telling you almost enough so you have to click
2. **Emotional hook** — grabbing your feelings before your thinking
3. **Information source** — where a piece of information came from
4. **Urgency cue** — words that say "act right now!"
5. **News story** — a real report about something that happened
6. **Fact** — a statement that can be checked with evidence
7. **News literacy** — the habits of reading news smartly
8. **Opinion** — a feeling or belief, not a fact
9. **Shocking headline** — a loud headline made to skip your thinking
10. **Misinformation** — wrong information shared by accident
11. **Satire** — writing that uses jokes to make a real point
12. **Disinformation** — wrong information shared on purpose
13. **Parody** — a funny copy of a well-known thing
14. **Rumor** — an unproven story passed person to person
15. **Viral post** — a post that spreads to millions, fast
16. **Hoax** — a fake story built to fool a lot of people
