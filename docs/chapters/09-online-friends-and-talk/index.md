---
title: "Chapter 9: Online Friends and How We Talk"
description: "Explore the difference between online and in-person friends, the meaning of tone and emoji in text, and how online conversations can be misunderstood."
...
7. Video Chat
8. Voice Chat
9. Online Only Friend
10. Read Receipt
11. Text Misunderstanding
12. Stranger Online
13. Friend Request
...
!!! mascot-welcome "Hi Friends!"
    ...
    Hi friends, it's Maka! Talking online is one of the best things about the digital world — and one of the trickiest. The same words that mean *yes* with a smile can sound like *whatever* with a shrug. In this chapter we'll learn how to talk so people *hear* what we mean. Pause, think, act!
...
!!! mascot-thinking "A Big Idea"
    ...
    Here's the secret of online talking: when in doubt, add warmth. One smile emoji. One "thanks!" One "no rush." Tiny words and tiny pictures fill in the tone that text usually leaves out. Pause, think, act!
...
<details markdown="1">
<summary>Tone Translator — interactive p5.js MicroSim</summary>
Type: microsim
**sim-id:** tone-translator<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
- A responsive canvas (default 720 × 460, resizes with container width via `updateCanvasSize()` called first in `setup()`).
- A pretend phone screen in the center showing one short message ("ok", "fine.", "whatever", "sure", "k", "alright").
...
- `createButton('Next message')` to load the next pretend message.
- `createButton('Reset')` to clear the score.
- `createSelect()` to switch the imagined sender's mood: Calm, Busy, Tired, Excited.
...
- File location: `docs/sims/tone-translator/` with `main.html`, `main.js`, and `index.md`.
...
1. **Online friend** — a friend you know mostly through screens
2. **Tone in text** — the feeling words seem to carry on a screen
3. **Direct message** — a private one-to-one message
4. **Emoji meaning** — what a small picture says about feelings
5. **Group chat** — a message space with three or more people
6. **In-person friend** — a friend you also know in real life
7. **Video chat** — a chat where you see and hear each other
8. **Voice chat** — a chat where you hear but don't see each other
9. **Online-only friend** — someone you've only met through a screen
10. **Read receipt** — a marker showing the other person saw your message
11. **Text misunderstanding** — when text is read in the wrong tone
12. **Stranger online** — anyone you don't know who appears online
13. **Friend request** — a message asking to be added to a friend list
