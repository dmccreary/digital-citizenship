...
Type: diagram
**sim-id:** digital-threshold-doorway<br/>
**Library:** AI Image Generator<br/>
**Status:** Specified
...
<details markdown="1">
<summary>Pause, Think, Act — interactive p5.js MicroSim</summary>
Type: microsim
**sim-id:** pause-think-act<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
<details markdown="1">
<summary>The four habits of a digital citizen — wagon illustration</summary>
Type: diagram
**sim-id:** four-habits-wagon<br/>
**Library:** AI Image Generator<br/>
**Status:** Specified
