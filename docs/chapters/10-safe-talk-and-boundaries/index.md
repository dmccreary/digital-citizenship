---
title: "Chapter 10: Safe Talk and Setting Boundaries"
description: "Learn the Safe Talk Rule (notice → stop → tell a trusted adult), how to use block, report, and mute features, and how to set healthy boundaries."
...
- [Chapter 9: Online Friends and How We Talk](../09-online-friends-and-talk/index.md)
...
!!! mascot-warning "The Safe Talk Rule"
...
<details markdown="1">
<summary>Safe Talk Sorter — interactive p5.js MicroSim</summary>
Type: microsim
**sim-id:** safe-talk-sorter<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
- A pretend chat window in the center showing one incoming message at a time.
...
- `createButton('Next message')` to load the next pretend chat from a bank of fifteen.
- `createButton('Reset')` to clear the score and start over.
- `createSelect()` to pick the chat setting: Game chat, Class group, Direct message, Comment thread.
...
- File location: `docs/sims/safe-talk-sorter/` with `main.html`, `main.js`, and `index.md`.
...
1. **Block feature** — a tool that stops a person from contacting you
2. **Polite reply** — a short, friendly answer that shows you care
3. **Safe Talk Rule** — notice, stop, tell a trusted adult
4. **All caps** — TYPING LIKE THIS, which feels like yelling
5. **Mute feature** — a tool that hides someone's posts without blocking
6. **Report feature** — a way to tell a website about a rule-breaker
7. **Respectful tone** — writing so the other person feels heard
8. **Stranger danger** — the rule about not trusting strangers online
9. **Warning sign** — any small "uh-oh" feeling in a conversation
10. **Boundary setting** — deciding your rules ahead of time
11. **Netiquette** — polite manners for talking through screens
12. **Stop conversation** — the moment you stop replying when something's off
13. **Tell adult** — the moment you go find a trusted adult and tell them
