---
title: "Chapter 16: Healthy Doubt and Open Minds"
description: "Learn how to use healthy doubt, spot your own biases, change your mind when the evidence changes, and stay open-minded."
...
!!! mascot-welcome "Hi Friends!"
    ...
    Hi friends, it's Maka. This chapter is about a really grown-up idea — being open to changing your mind. It is one of the bravest things a thinker can do. By the end, you'll see why it actually feels *good*. Pause, think, act!
...
!!! mascot-thinking "A Big Idea"
    ...
    Two things happening at the same time is not the same as one causing the other. Roosters crow before sunrise — but that does not mean roosters make the sun come up. Pause, think, act!
...
<details markdown="1">
<summary>Mind-Changer Quiz — interactive p5.js MicroSim</summary>
Type: microsim
**sim-id:** mind-changer-quiz<br/>
**Library:** p5.js<br/>
**Status:** Specified
