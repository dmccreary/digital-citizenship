...
| Concepts | 265 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 267 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 91 | [FAQ](../faq.md) | Frequently asked questions |
...
|-------------|-------------|---------------|-------|
| Diagrams | 5 | 5 | H4 headers starting with '#### Diagram:' |
| Equations | 0 | 0 | LaTeX expressions (inline and display) |
| Total Words | 117,237 | 83,462 | Words in markdown files |
| Links | 373 | 220 | Hyperlinks in markdown format |
| Equivalent Pages | 471 | 336 | Estimated pages (250 words/page + visuals) |
